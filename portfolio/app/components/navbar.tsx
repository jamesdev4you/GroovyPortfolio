...
export default function NavBar() {
    ...
    return (
        <nav className="fixed z-50 top-0 w-full h-20 bg-background flex items-center justify-evenly px-4 md:pl-4 md:pr-16">
            {/* This is for medium screens */}
            <div className="md:flex text-3xl font-display text-foreground">James Boyle</div>
            ...
            <button
                className="md:hidden hover:cursor-pointer ml-auto font-body bg-foreground hover:bg-background  text-background font-semibold hover:text-foreground py-2 px-4 border border-background  rounded"
